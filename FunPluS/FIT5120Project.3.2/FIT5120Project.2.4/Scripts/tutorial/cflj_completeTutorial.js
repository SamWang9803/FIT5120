...
const introWords = {
  1: "With ChattyFish LoveJokes, we are going to <span style = 'color: #8425FF'>write a positive postcard</span> with some words we choose.",
  2: "By writing a <span style = 'color: #8425FF'>positive message on the postcard</span>, we will <span style = 'color: #8425FF'>earn some tokens</span> for fun activities!",
  3: "What are we waiting for?<br>Let's get started!",
  4: "We can get the words given here!",
  5: "These words are selected from some <span style = 'color: #8425FF'>funny jokes</span> here.",
  6: "If you <span style = 'color: brown'>don't like these words</span>, simply <span style = 'color: brown'>click the arrows</span> to check out more options.",
  7: "Let's use these words for our postcard for now.",
  8: "If you hover words in <span style = 'color:#A3B246'>'given words'</span>, you can see more options available.",
  9: "Here are the <span style = 'color:#75966B'>'chosen words'</span> that we got just now.",
  10: "Word block appears in this box whenever you <span style = 'color: #8425FF'>click a word.",
  11: "With the words we chose, we can write a message like this.",
  12: "If you want to choose <span style = 'color: #8425FF'>other words for the message</span>, you can click this button to go back.",
  13: "If you want to <span style = 'color: brown'>rewrite the message</span>, you can click this button.",
  14: "For now, let's try to send this message out!",
  15: "Here, you can choose different postcard designs.",
  ...
  21: "Before sending out postcards, we should always think of <span style = 'color: #8425FF'>how it could make others feel</span>!",
  22: "Once we <span style = 'color: #8425FF'>reflect on our message</span>, we can finally send out our postcard.",
  24: "Based on how the reader feels about our postcard, we'll be able to <span style = 'color: #8425FF'>earn the tokens</span>.",
  25: "We'll also <span style = 'color: #8425FF'>receive postcard from others</span>, and tell them how we felt of their postcards.",
