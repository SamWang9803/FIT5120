...
var introWords = {
  1: "Here, we can check the <span style = 'color:orange';>postcards we received</span> from others.",
  2: "We have received one postcard from someone! Let's check it out!",
  3: "Once we read the postcard, we'll <span style = 'color:orange';>tell the writer on how we felt</span> by reading the message they wrote.",
  4: "By telling the writer on how we felt of their message, we can <span style = 'color:orange';>help them reflect on the message</span> they write to others.",
  ...
  7: "Let's check out the <span style = 'color:orange';>postcard we sent out</span> just now!",
  8: "As such, to get more tokens, we should do our best <span style = 'color:orange';>send out positive postcards</span>!"
};
